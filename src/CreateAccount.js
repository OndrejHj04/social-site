      ...
      <div className="flex flex-col w-11/12 mx-auto max-w-2xl my-10">
        ...
        <form className="flex flex-col text-xl max-w-96 mx-auto" onSubmit={submit}>
          ...
          <div className="flex flex-wrap justify-between">
            ...
            <input className="m-2 p-1 w-full sm:w-auto border-2" name="password" type="password" onChange={change} value={createProfile.password} autoComplete="" />
          </div>

          <div className="flex flex-wrap justify-between">
            <label className="my-auto mx-2 w-full sm:w-auto">Confirm password</label>
            <input className="m-2 p-1 w-full sm:w-auto border-2" name="password2" type="password" onChange={change} value={createProfile.password2} autoComplete="" />
          </div>
